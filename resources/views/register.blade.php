...
<script>
    (async () => {
        ...
        const arrayOfPositions = (async () => {
            const positionsValue = await fetch('https://test-assignment-nginx.fly.dev/api/v1/positions/', {
                method: 'GET',
                headers: {
        ...
        const token = async function () {
            const tokenValue = await fetch('https://test-assignment-nginx.fly.dev/api/v1/token')
                .then(res => res.json())
                .catch(error => {
                    console.error(error)
                });
        ...
        const store = (async () => {
            ...
            await fetch('https://test-assignment-nginx.fly.dev/api/v1/users/', {
                method: 'POST',
                redirect: 'follow',
                headers: {
